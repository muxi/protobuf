Pod::Spec.new do |s|
  ...
  # Use experiment version number until stabilized
  # s.version  = '3.5.1'
  s.version = '0.0.1'
  ...
  s.source_files = 'src/google/protobuf/*.{h,cc}',
                   'src/google/protobuf/stubs/*.{h,cc}',
                   'src/google/protobuf/io/*.{h,cc}'

  # Excluding all the tests in the three directories above
  ...
  s.header_mappings_dir = 'src/protobuf'
